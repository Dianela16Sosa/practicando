define([], function(){
	...
	//For Operation 'getPostedUserTransactions' with service id 'searchTransactions4812'
	...
	//For Operation 'getLoanSchedule' with service id 'loanScheduleTransaction5082'
	...
	//For Operation 'getAccountTransactionByType' with service id 'getTransactions2280'
	...
	//For Operation 'getAllTransactionsForAdmin' with service id 'getAllTransactionsForAdminCompletedAndPending9276'
	...
	//For Operation 'getBlockedFunds' with service id 'getBlockedFunds3181'
	...
	//For Operation 'getAccountPostedTransactionsPreview' with service id 'GetAccountPostedTransactionsPreview1656'
	...
	//For Operation 'getTransactionsNew' with service id 'getTransactions8021'
	TransactionsRepository.prototype.getTransactionsNew = function(params, onCompletion){
		return TransactionsRepository.prototype.customVerb('getTransactionsNew', params, onCompletion);
	};
	...
	//For Operation 'getAccountPostedTransactions' with service id 'getPostedUserTransactions3076'

...
define([], function() {
    ...
    //For Operation 'UpdateUsernameDBXDB' with service id 'dbxdb_customer_update1218'
     User.UpdateUsernameDBXDB = function(params, onCompletion){
        return User.customVerb('UpdateUsernameDBXDB', params, onCompletion);
     };
    ...
    //For Operation 'unlockUser' with service id 'unlockUser7735'
     User.unlockUser = function(params, onCompletion){
        return User.customVerb('unlockUser', params, onCompletion);
     };
    ...
    //For Operation 'updateUserEmail' with service id 'updateUserEmail1468'
     User.updateUserEmail = function(params, onCompletion){
        return User.customVerb('updateUserEmail', params, onCompletion);
     };
    ...
    //For Operation 'UpdateUser' with service id 'UpdateUser3437'
     User.UpdateUser = function(params, onCompletion){
        return User.customVerb('UpdateUser', params, onCompletion);
     };

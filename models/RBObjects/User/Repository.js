define([], function(){
	...
	//For Operation 'UpdateUsernameDBXDB' with service id 'dbxdb_customer_update1218'
	UserRepository.prototype.UpdateUsernameDBXDB = function(params, onCompletion){
		return UserRepository.prototype.customVerb('UpdateUsernameDBXDB', params, onCompletion);
	};
	...
	//For Operation 'unlockUser' with service id 'unlockUser7735'
	UserRepository.prototype.unlockUser = function(params, onCompletion){
		return UserRepository.prototype.customVerb('unlockUser', params, onCompletion);
	};
	...
	//For Operation 'updateUserEmail' with service id 'updateUserEmail1468'
	UserRepository.prototype.updateUserEmail = function(params, onCompletion){
		return UserRepository.prototype.customVerb('updateUserEmail', params, onCompletion);
	};
	...
	//For Operation 'UpdateUser' with service id 'UpdateUser3437'
	UserRepository.prototype.UpdateUser = function(params, onCompletion){
		return UserRepository.prototype.customVerb('UpdateUser', params, onCompletion);
	};

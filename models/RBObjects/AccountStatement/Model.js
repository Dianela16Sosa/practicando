...
define([], function() {
    ...
    //For Operation 'searchDocumentBCI' with service id 'searchDocumentBCI5102'
     AccountStatement.searchDocumentBCI = function(params, onCompletion){
        return AccountStatement.customVerb('searchDocumentBCI', params, onCompletion);
     };

    //For Operation 'getDocumentBCI' with service id 'getDocumentBCI2732'
     AccountStatement.getDocumentBCI = function(params, onCompletion){
        return AccountStatement.customVerb('getDocumentBCI', params, onCompletion);
     };

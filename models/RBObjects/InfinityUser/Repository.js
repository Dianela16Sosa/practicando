define([], function(){
	...
	//For Operation 'getInfinityUser_stub' with service id 'getInfinityUser9600'
	InfinityUserRepository.prototype.getInfinityUser_stub = function(params, onCompletion){
		return InfinityUserRepository.prototype.customVerb('getInfinityUser_stub', params, onCompletion);
	};
	...
	//For Operation 'verifyInfinityCustomRoleName_stub' with service id 'verifyInfinityCustomRoleName8405'
	InfinityUserRepository.prototype.verifyInfinityCustomRoleName_stub = function(params, onCompletion){
		return InfinityUserRepository.prototype.customVerb('verifyInfinityCustomRoleName_stub', params, onCompletion);
	};
	...
	//For Operation 'GetListCoreCustomerFeatureActionLimits_stub' with service id 'GetListCoreCustomerFeatureActionLimits8482'
	InfinityUserRepository.prototype.GetListCoreCustomerFeatureActionLimits_stub = function(params, onCompletion){
		return InfinityUserRepository.prototype.customVerb('GetListCoreCustomerFeatureActionLimits_stub', params, onCompletion);
	};
	...
	//For Operation 'getAssociatedContractUsers_stub' with service id 'getAssociatedContractUsers7846'
	InfinityUserRepository.prototype.getAssociatedContractUsers_stub = function(params, onCompletion){
		return InfinityUserRepository.prototype.customVerb('getAssociatedContractUsers_stub', params, onCompletion);
	};
	...
	//For Operation 'getCompanyLevelCustomRoles_stub' with service id 'getCompanyLevelCustomRoles8536'
	InfinityUserRepository.prototype.getCompanyLevelCustomRoles_stub = function(params, onCompletion){
		return InfinityUserRepository.prototype.customVerb('getCompanyLevelCustomRoles_stub', params, onCompletion);
	};
	...
	//For Operation 'createInfinityCustomRole_stub' with service id 'createInfinityCustomRole5016'
	InfinityUserRepository.prototype.createInfinityCustomRole_stub = function(params, onCompletion){
		return InfinityUserRepository.prototype.customVerb('createInfinityCustomRole_stub', params, onCompletion);
	};
	...
	//For Operation 'getInfinityCustomRoleDetails_stub' with service id 'getInfinityCustomRoleDetails6518'
	InfinityUserRepository.prototype.getInfinityCustomRoleDetails_stub = function(params, onCompletion){
		return InfinityUserRepository.prototype.customVerb('getInfinityCustomRoleDetails_stub', params, onCompletion);
	};

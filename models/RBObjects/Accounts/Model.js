...
define([], function() {
    ...
    var setterFunctions = {
        ...
        totalDepositBalances: function(val, state) {
            context["field"] = "totalDepositBalances";
            context["metadata"] = (objectMetadata ? objectMetadata["totalDepositBalances"] : null);
            state['totalDepositBalances'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        overdraftAmount: function(val, state) {
            context["field"] = "overdraftAmount";
            context["metadata"] = (objectMetadata ? objectMetadata["overdraftAmount"] : null);
            state['overdraftAmount'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        pdfBase64: function(val, state) {
            context["field"] = "pdfBase64";
            context["metadata"] = (objectMetadata ? objectMetadata["pdfBase64"] : null);
            state['pdfBase64'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        overrideDate: function(val, state) {
            context["field"] = "overrideDate";
            context["metadata"] = (objectMetadata ? objectMetadata["overrideDate"] : null);
            state['overrideDate'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        currencySymbol: function(val, state) {
            context["field"] = "currencySymbol";
            context["metadata"] = (objectMetadata ? objectMetadata["currencySymbol"] : null);
            state['currencySymbol'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    ...
    function Accounts(defaultValues) {
        ...
        context["field"] = "totalDepositBalances";
        context["metadata"] = (objectMetadata ? objectMetadata["totalDepositBalances"] : null);
        privateState.totalDepositBalances = defaultValues ?
            (defaultValues["totalDepositBalances"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["totalDepositBalances"], context) :
                null) :
            null;

        context["field"] = "overdraftAmount";
        context["metadata"] = (objectMetadata ? objectMetadata["overdraftAmount"] : null);
        privateState.overdraftAmount = defaultValues ?
            (defaultValues["overdraftAmount"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["overdraftAmount"], context) :
                null) :
            null;

        context["field"] = "pdfBase64";
        context["metadata"] = (objectMetadata ? objectMetadata["pdfBase64"] : null);
        privateState.pdfBase64 = defaultValues ?
            (defaultValues["pdfBase64"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["pdfBase64"], context) :
                null) :
            null;
        ...
        context["field"] = "overrideDate";
        context["metadata"] = (objectMetadata ? objectMetadata["overrideDate"] : null);
        privateState.overrideDate = defaultValues ?
            (defaultValues["overrideDate"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["overrideDate"], context) :
                null) :
            null;
        ...
        context["field"] = "currencySymbol";
        context["metadata"] = (objectMetadata ? objectMetadata["currencySymbol"] : null);
        privateState.currencySymbol = defaultValues ?
            (defaultValues["currencySymbol"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["currencySymbol"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "totalDepositBalances": {
                get: function() {
                    context["field"] = "totalDepositBalances";
                    context["metadata"] = (objectMetadata ? objectMetadata["totalDepositBalances"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.totalDepositBalances, context);
                },
                set: function(val) {
                    setterFunctions['totalDepositBalances'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "overdraftAmount": {
                get: function() {
                    context["field"] = "overdraftAmount";
                    context["metadata"] = (objectMetadata ? objectMetadata["overdraftAmount"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.overdraftAmount, context);
                },
                set: function(val) {
                    setterFunctions['overdraftAmount'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "pdfBase64": {
                get: function() {
                    context["field"] = "pdfBase64";
                    context["metadata"] = (objectMetadata ? objectMetadata["pdfBase64"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.pdfBase64, context);
                },
                set: function(val) {
                    setterFunctions['pdfBase64'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "accountNumber": {
            ...
            "overrideDate": {
                get: function() {
                    context["field"] = "overrideDate";
                    context["metadata"] = (objectMetadata ? objectMetadata["overrideDate"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.overrideDate, context);
                },
                set: function(val) {
                    setterFunctions['overrideDate'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "accountIBAN": {
            ...
            "currencySymbol": {
                get: function() {
                    context["field"] = "currencySymbol";
                    context["metadata"] = (objectMetadata ? objectMetadata["currencySymbol"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.currencySymbol, context);
                },
                set: function(val) {
                    setterFunctions['currencySymbol'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.totalDepositBalances = value ? (value["totalDepositBalances"] ? value["totalDepositBalances"] : null) : null;
            privateState.overdraftAmount = value ? (value["overdraftAmount"] ? value["overdraftAmount"] : null) : null;
            privateState.pdfBase64 = value ? (value["pdfBase64"] ? value["pdfBase64"] : null) : null;
            ...
            privateState.overrideDate = value ? (value["overrideDate"] ? value["overrideDate"] : null) : null;
            privateState.accountIBAN = value ? (value["accountIBAN"] ? value["accountIBAN"] : null) : null;
            privateState.currencySymbol = value ? (value["currencySymbol"] ? value["currencySymbol"] : null) : null;
        };
    }
    ...
    //For Operation 'getLoanDueAmount' with service id 'getLoanDueAmount6510'
     Accounts.getLoanDueAmount = function(params, onCompletion){
        return Accounts.customVerb('getLoanDueAmount', params, onCompletion);
     };
    ...
    //For Operation 'getDepositDetails' with service id 'getDepositDetails4526'
     Accounts.getDepositDetails = function(params, onCompletion){
        return Accounts.customVerb('getDepositDetails', params, onCompletion);
     };

    //For Operation 'getCheckingDetails' with service id 'getCheckingDetails8163'
     Accounts.getCheckingDetails = function(params, onCompletion){
        return Accounts.customVerb('getCheckingDetails', params, onCompletion);
     };

    //For Operation 'downloadEstatement' with service id 'downloadTransactionHistory3715'
     Accounts.downloadEstatement = function(params, onCompletion){
        return Accounts.customVerb('downloadEstatement', params, onCompletion);
     };
    ...
    //For Operation 'CreatePayoffSimulation' with service id 'CreatePayoffSimulation3835'
     Accounts.CreatePayoffSimulation = function(params, onCompletion){
        return Accounts.customVerb('CreatePayoffSimulation', params, onCompletion);
     };
    ...
    //For Operation 'getLoanPayoffStatement' with service id 'getLoanPayoffStatement1465'
     Accounts.getLoanPayoffStatement = function(params, onCompletion){
        return Accounts.customVerb('getLoanPayoffStatement', params, onCompletion);
     };
    ...
    //For Operation 'getLoanDetails' with service id 'getLoanDetails5844'
     Accounts.getLoanDetails = function(params, onCompletion){
        return Accounts.customVerb('getLoanDetails', params, onCompletion);
     };
    ...
    //For Operation 'getLoanSchedule' with service id 'getLoanSchedule2344'
     Accounts.getLoanSchedule = function(params, onCompletion){
        return Accounts.customVerb('getLoanSchedule', params, onCompletion);
     };
    ...
    //For Operation 'getAccountsNew' with service id 'getAccounts8576'
     Accounts.getAccountsNew = function(params, onCompletion){
        return Accounts.customVerb('getAccountsNew', params, onCompletion);
     };
    ...
    //For Operation 'getAccountDetailsNew' with service id 'getAccountDetails9348'
     Accounts.getAccountDetailsNew = function(params, onCompletion){
        return Accounts.customVerb('getAccountDetailsNew', params, onCompletion);
     };
    ...
    //For Operation 'getPayoffSimulationStatus' with service id 'getPayoffSimulationStatus4477'
     Accounts.getPayoffSimulationStatus = function(params, onCompletion){
        return Accounts.customVerb('getPayoffSimulationStatus', params, onCompletion);
     };
